...
export const SYNONYM_MAP: Record<string, string> = {
  ...
  '대지':'토지','임야':'토지','전답':'토지',
  // 시설
  '올리':'올수리','전체수리':'올수리','새로수리':'올수리','올리모델링':'올수리','깔끔하게수리':'올수리','전면수리':'올수리','완전수리':'올수리',
  '일부수리':'부분수리','도배장판':'부분수리','욕실수리':'부분수리',
  '리모':'리모델링',
  '풀옵':'풀옵션','가전풀':'풀옵션','가구포함':'풀옵션','옵션풀':'풀옵션','가전제품포함':'풀옵션',
  '즉입':'즉시입주','바로입주':'즉시입주','입주가능':'즉시입주',
  ...
  '역도보':'역세권','역에서':'역세권','지하철근처':'역세권','역앞':'역세권','역근처':'역세권',
  '트리플역세권':'더블역세권','2개노선':'더블역세권',
  '버스정류장':'대중교통편리','교통편리':'대중교통편리',
  '큰길가':'대로변','간선도로':'대로변',
  // 교육
  '학교근처':'학군좋음','학교앞':'학군좋음','초등학교':'학군좋음','중학교':'학군좋음','명문학군':'학군좋음','교육환경':'학군좋음',
  '학원밀집':'학원가',
  '대학교근처':'학세권','대학가':'학세권',
  // 뷰
  '한강조망':'한강뷰','리버뷰':'한강뷰',
  ...
  // 금융조건
  '허그':'HUG가능','안심전세':'HUG가능','보증보험':'HUG가능','허그가능':'HUG가능','전세보증':'HUG가능','보증보험OK':'HUG가능','보험가능':'HUG가능',
  ...
  '자주식주차':'주차가능','주차1대이상':'주차가능','주차됨':'주차가능','주차OK':'주차가능','차댈곳':'주차가능',
  '반려견가능':'애견가능','강아지OK':'애견가능','강아지가능':'애견가능','동물가능':'애견가능','반려견OK':'애견가능',
  // 환경
  '한적':'조용한동네','주택가':'조용한동네',
...
function extractFromText(text: string): string[] {
  ...
  if (/구축|노후|연식\s*오래|오래된\s*건물/.test(t)) tags.push('구축');
  // 금융조건
